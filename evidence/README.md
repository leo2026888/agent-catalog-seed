...
| --- | --- | --- | --- |
| narrated-video-review | 关联作者公开 Skill 发布、结构校验 | 0.1.0；固定公开提交 | Skill 为 MIT；未独立实际剪辑或跨平台验证 |
...
| Anthropic PDF Skill | 作者仓库、前言、部分正文及独立许可证查看 | 独立发行版本未知，固定提交仅作来源快照 | Proprietary；只提供原创摘要与来源链接，不复制实现 |
...
欢迎使用 [纠错入口](https://github.com/leo2026888/agent-catalog-seed/issues/new?template=correction.yml) 或 [证据贡献入口](https://github.com/leo2026888/agent-catalog-seed/issues/new?template=evidence.yml) 提交可公开、可追溯的补充。GitHub Issue 公开，请勿附凭证、客户数据或私有日志。
